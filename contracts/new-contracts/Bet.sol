...
contract Bets is ERC20 {
    ...
    mapping(string => BetLibrary.Bet) public bets;
    ...
    */
    ...
    /*
        ...
        @param _amount Quantity of tokens for bet
    */
    function createOpen(uint256 _amount, string calldata _id) external {
...
/*
    ...
    @param _amount Quantity of tokens for bet
*/
function betOpen(uint256 _amount, string calldata _id) external {
require(balances[msg.sender] >= _amount);
...
approve(address (this), _amount*2);
